...
namespace veb
{
	[SpecialExecutionTaskName("TN3270CloseSession")]
	public class TN3270CloseSession : SpecialExecutionTask
	{
		#region Public Methods and Operators

		public TN3270CloseSession(Validator validator)
			: base(validator)
		{
		}
...
// Rest Service konfigurierbar machen?
			...
			var request = new RestRequest("tn3270/closesession", Method.POST);
			...
			if (rowCode == "0") {
				...
				return new  NotFoundFailedActionResult("Command failed: " + content + " for request: [host=" + paraHost + "; port=" + paraPort + "]");
			} // fi
		} // etucexe
		#endregion
	}
